...
typedef enum {
    ...
    cy_propertyMemoryManagementPolicyAssign = 0,
    /// The value is retained.
    cy_propertyMemoryManagementPolicyRetain,
    /// The value is copied.
    cy_propertyMemoryManagementPolicyCopy
} cy_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     * #cy_propertyMemoryManagementPolicyAssign if #readonly is \c YES.
     */
    cy_propertyMemoryManagementPolicy memoryManagementPolicy;
    /**
