#
#  Be sure to run `pod spec lint Cheneyee.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Cheney"
  # spec.authors            = { "Cheney" => "saygoodlolita@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Cheney"
